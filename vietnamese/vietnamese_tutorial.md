...
- Đây là file [base_dataset.py](base_dataset_vietnamese.py) mà mình đã sử dụng, nếu không có gì sai sót thì bạn sẽ nhận được một file [vocab.json](vocab.json) như này khi chạy.
